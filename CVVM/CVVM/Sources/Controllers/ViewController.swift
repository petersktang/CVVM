...
class ViewController: CollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        self.source  = CollectionViewSource(grid: grid, sections: [albumSection, artistSection, albumSection, artistSection])
...
//        let items = artists.map { artist -> ArtistViewModel in
//            let viewModel = ArtistViewModel(artist)
//            viewModel.delegate = self
//            return viewModel
//        }
